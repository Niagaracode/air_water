...
class _SearchAndFiltersState extends ConsumerState<SearchAndFilters> {
  ...
  void _clearFilters() {
    // Clears the global search bar too, since it now lives in the header.
  ...
  Widget build(BuildContext context) {
    ...
    // Forward changes to the page's own filtering logic, same as
    // before — just sourced from the shared provider instead of a
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  if (searchText.isNotEmpty && _resultCount > 0)
                    Container(
